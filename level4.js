...
{
    let color=JSON.parse(localStorage.getItem("color4"))||"#000";
    ...
    button.onclick=function()
    {
        ...
        localStorage.setItem("color4",JSON.stringify("#"+randomColor));
    }
    ...
    button.onclick=function()
    {
        ...
        localStorage.setItem("color4",JSON.stringify("#000"));
    };
}